...
if(NOT EXISTS ${THIRD_PARTY_PATH}/pybind/src/extern_pybind/.git)
    message(STATUS "pybind not found. downloading from github")
    ExternalProject_Add(
            extern_pybind
    ...
    message(STATUS "pybind found. skip downloading")
endif()
